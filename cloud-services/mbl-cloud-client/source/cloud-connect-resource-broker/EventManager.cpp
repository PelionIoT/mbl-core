...
// bool EventManager::validate_common_event_parameters(EventDataType data_type,
//                                                     unsigned long data_length)
// {
//     switch (data_type)
//     {
//     case EventDataType::RAW:
//         if (data_length > Event::EventData::MAX_BYTES) {
//             TR_ERR(
//                 "Illegal data_length of size %lu > %d", data_length,
//                 Event::EventData::MAX_BYTES);
//             return false;
//         }
//         break;
