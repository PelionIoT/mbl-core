...
int EventManager::self_event_handler_impl(sd_event_source *s, SelfEvent *ev)
{
    ...
    //TODO consider adding a "free pool" to avoid dynamic allocations and deallocations, this will
    //be a vector or queue of free events with intialization to some initial amounts of elements.
