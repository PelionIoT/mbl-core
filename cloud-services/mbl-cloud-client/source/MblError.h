...
enum Type {
    ...
    UpdateWarningAuthorizationRejected    = 0x0209,
    UpdateWarningAuthorizationUnavailable = 0x020a,
    UpdateWarningUnknown                  = 0x020b,
    UpdateErrorWriteToStorage             = 0x020c,
    UpdateWarningNoActionRequired         = 0x020d,
    UpdateErrorUserActionRequired         = 0x020e,
    UpdateFatalRebootRequired             = 0x020f,
    UpdateErrorInvalidHash                = 0x0210,
    UpdateWarningBadKeytable              = 0x0211,
    UpdateCertificateInsertion            = 0x0212,
    UpdateErrorConnection                 = 0x0213,
