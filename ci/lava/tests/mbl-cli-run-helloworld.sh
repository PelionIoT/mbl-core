...
then
    ...
    $mbl_command shell "mbl-firmware-update-manager -i /tmp/user-sample-app-package_1.0_any.ipk.tar --skip-reboot"
    ...
    $mbl_command shell "mbl-app-manager remove user-sample-app-package /tmp/user-sample-app-package"
