...
class TestHostname:
    ...
    def test_hostname_factory_cfg_exist_add_usr_cfg(
        self
    ):
    ...
    def test_hostname_factory_cfg_exist_modify_usr_cfg(
        self
    ):
    ...
    def test_hostname_factory_cfg_exist_remove_user_config(
        self
    ):
    ...
    def test_hostname_no_factory_cfg_remove_user_config(
        self
    ):
